...
| DEC-005 | Discovery 40h SOW | proposed | Alex | 2025-11-04 | Принять/не принять | Принять | Быстрый риск‑снятие и выработка C4/событий/API/shortlists | 76ca/kickoff-pack.md | Назначить 90‑мин Kickoff |
